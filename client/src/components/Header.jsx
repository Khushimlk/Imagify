...
const Header = () => {
  ...
  return (
      ...
      px-6 py-1 rounded-full border border-neutral-500'
        ...
        <motion.p className='text-center max-w-xl mx-auto mt-5'
          ...
          transition={{delay: 0.6, duration: 0.8 }}>
            ...
            seconds - just type, ans watch the magic happen.
        </motion.p>

        <motion.button onClick={onClickHander} className='sm:text-lg text-white bg-black w-auto 
    ...
    className='mt-2 text-neutral-6 00'>Generated images from imagify</motion.p>
